 ...
 * the assistant-output tint switch. Registered by this package — the theme
...
import { OUTPUT_TINT_COLOR, type ThemePreference } from '../theme-settings.ts'
    ...
    <div className={css.group}>
      ...
      <div className={css.toggleRow}>
        ...
        <button
          ...
          onClick={() => { setOutputTint(tintOn ? '' : OUTPUT_TINT_COLOR) }}
        />
      </div>
    </div>
  )
